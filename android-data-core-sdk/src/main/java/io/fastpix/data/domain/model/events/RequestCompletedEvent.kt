...
class RequestCompletedEvent(
    ...
    @SerialName("evna") var eventName: String = "requestCompleted"
) : BaseEvent(
    ...
    override fun toJson(): Map<String, String?> {
        ...
        return baseJson + mapOf(
            ...
            "rqrphs" to requestResponseHeaders,
    ...
    companion object {
         ...
         */
        fun createRequestCompletedEvent(configService: SDKConfiguration): RequestCompletedEvent {
